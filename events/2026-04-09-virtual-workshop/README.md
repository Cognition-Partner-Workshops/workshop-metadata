# Workshop: QA & Quality Engineering — Virtual Workshop
...
- **Try parallel sessions.** Several labs suggest running multiple Devin sessions at once (e.g., migrating unit tests and E2E tests in parallel). This mirrors real enterprise usage where Devin handles repetitive work across many services.
...
This event features 5 labs that follow a progressive quality engineering narrative:

- Lab 1: **Test Coverage Audit & Unit Test Generation** — Assess coverage gaps and generate unit tests to close them
- Lab 2: **E2E Testing with Browser Automation** — Write Playwright end-to-end tests with Devin driving a real browser
- Lab 3: **Test Framework Migration** — Migrate a codebase from deprecated test frameworks to modern replacements
- Lab 4: **BDD Test Generation for REST APIs** — Generate Cucumber BDD test scenarios and build new API resources with matching tests
- Lab 5: **Continuous Quality Engineering** — Set up scheduled Devin sessions, Playbooks, and Knowledge for ongoing test quality automation

### Lab 1 — Test Coverage Audit & Unit Test Generation (45 min)
...
### Lab 2 — E2E Testing with Browser Automation (60 min)
...
### Lab 3 — Test Framework Migration (60 min)
...
### Lab 4 — BDD Test Generation for REST APIs (60 min)
...
### Lab 5 — Continuous Quality Engineering (45 min)
...
This is the capstone lab. Participants tie together everything from Labs 1-4 and set up Devin as an ongoing quality engineering team member.
...
Based on what you learned in Labs 1-4, create **Knowledge items** that will automatically inform all future Devin sessions:
...
- **Key Takeaways:**
  ...
  - **"Knowledge compounds over time"** — every Knowledge item created in Labs 1-4 makes future sessions better. Devin remembers your project's testing conventions, framework preferences, and quality standards
...
- **Audience:** QA engineers, SDETs, test automation engineers, quality assurance leads
- **Focus:** Progressive quality engineering — from manual test generation through framework migration to continuous automated quality monitoring
- **Testing narrative:** Each lab builds on the last: assess coverage (Lab 1) → automate browser testing (Lab 2) → modernize test infrastructure (Lab 3) → generate BDD tests from specs (Lab 4) → automate it all continuously (Lab 5)
- **Devin value themes woven throughout:**
  - Autonomous, off-machine execution — kick off sessions and move on
  - Browser interaction and screen recording for E2E testing
  - Parallel sessions for scaling repetitive migration work
  ...
  - Scheduled sessions for continuous quality hygiene
