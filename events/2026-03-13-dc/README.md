...
| | |
|---|---|
| **Module** | [C10 — Legacy Modernization Combined](../../modules/migration-modernization/C10.md) |
...
| | |
|---|---|
| **Module** | [C9 — Repetitive Framework Upgrades](../../modules/migration-modernization/C9.md) |
...
| | |
|---|---|
| **Module** | [C8 — Data Source Migration](../../modules/migration-modernization/C8.md) |
...
| | |
|---|---|
| **Module** | [D6 — New Feature Development](../../modules/feature-development/D6.md) |
...
|----------|-----------|--------|------|-----------|------|
| Modernization | COBOL → Java | [C1](../../modules/migration-modernization/C1.md) | uc-legacy-modernization-cobol-to-java | Advanced | 60 min |
| Upgrades | Spring Boot 2→3 | [C9](../../modules/migration-modernization/C9.md) | uc-framework-upgrade-monolith-to-microservices | Intermediate | 60 min |
| Data Migration | Legacy → Modern Schema | [C8](../../modules/migration-modernization/C8.md) | uc-data-source-migration-legacy-to-modern | Intermediate | 60 min |
| Feature Dev | New CRUD Feature | [D6](../../modules/feature-development/D6.md) | app_timesheet-client | Intermediate | 60 min |
| Security | CVE Remediation | [B1-B4](../../modules/security/README.md) | uc-cve-remediation-regulatory-compliance | Intermediate | 60 min |
| Quality | Unit Testing | [A2](../../modules/quality-engineering/A2.md) | Any | Beginner | 30 min |
