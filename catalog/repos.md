...
| **C12** | .NET/Angular Containerized Decomposition | *original* | `app_dotnet_angular_containerized_decomposition_monolith`, `app_dotnet_angular_containerized_decomposition_microservices`, `app_dotnet_angular_containerized_decomposition_microfrontends`, `app_dotnet_angular_containerized_decomposition_iac` | Four-repo decomposition workshop: before-state monolith (imported from QuickApp), target-state .NET microservices, target-state Angular micro-frontends, and app-specific IaC for Kubernetes deployment. |
| **C13** | Oracle Forms HRMS Modernization | *original* | `ts-plsql-oracle-forms-legacy-codebase`, `uc-legacy-modernization-oracle-forms-to-java` | Legacy Oracle Forms/PL/SQL HRMS application paired with Java/Spring Boot migration artifacts, test harness, and architecture documentation. Legacy repo is the static analysis target; use-case repo holds migration planning, target code, and equivalence tests. |
...
| **License** | MIT |
| **Default Branch** | `main` |
| **Cluster** | C13 (companion to `ts-plsql-oracle-forms-legacy-codebase`) |
...
| **License** | MIT |
| **Default Branch** | `main` |
| **Cluster** | C13 (companion to `uc-legacy-modernization-oracle-forms-to-java`) |
