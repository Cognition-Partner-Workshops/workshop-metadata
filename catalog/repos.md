...
| **C2** | AWS CardDemo (COBOL) | [`aws-samples/ts-cobol-carddemo`](https://github.com/aws-samples/ts-cobol-carddemo) | `ts-cobol-carddemo`, `uc-legacy-modernization-cobol-to-java` | Lab 1 uses a dedicated copy for COBOL-to-Java migration. Original fork retained. |
...
| **C5** | Cal.com ecosystem | [`calcom/calcom`](https://github.com/calcom/calcom) | `calcom`, `calcom-infra`, `calcom-dataeng` | Main app (fork) plus infra and data-eng repos built around it. |
