...
- The Notification service must be implemented with the currency formatting bug. Use the `devin/1773765870-workshop-notification-bug-hunt` branch of `app_dotnet_angular_containerized_decomposition_microservices`
...
- It can also be run standalone — participants don't need to have done MM15/MM16, they just need the buggy branch
...
Branch: `devin/1773765870-workshop-notification-bug-hunt`

The Notification service on this branch has a fully implemented order confirmation email renderer with the planted currency formatting bug. Key files:
...
>
> Investigate and fix this bug in `app_dotnet_angular_containerized_decomposition_microservices` on branch `devin/1773765870-workshop-notification-bug-hunt`.
>
> To reproduce:
