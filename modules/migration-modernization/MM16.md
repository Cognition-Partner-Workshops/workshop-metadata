...
- If participants haven't completed MM15, they can use the `scaffold/initial` branch of the microservices repo which has the service scaffold — but the tests will need the services to be implemented
...
>
> Work on branch `workshop-<participant>`.
>
> Context:
...
>
> Open a PR with the test suite and a summary of test coverage.
